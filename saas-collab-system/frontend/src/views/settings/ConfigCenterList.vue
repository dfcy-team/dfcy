...
import { fetchConfigDefinitions } from '../../api/configCenter';
...
const columns = [
  { prop: 'config_key', label: '配置键', width: 220 }, { prop: 'scope_type', label: '范围' }, { prop: 'value_type', label: '值类型' },
  { prop: 'is_sensitive', label: '敏感配置', type: 'status' }, { prop: 'requires_approval', label: '需要审批', type: 'status' },
  { prop: 'description', label: '说明', width: 260 }
];
const rowActions = [
