...
export const createProductSpu = (data) => requestWithMockFallback({ method: 'post', url: '/api/internal/products/spus/', data }, {}, 'products.spus.create');
export const createProductSku = (data) => requestWithMockFallback({ method: 'post', url: '/api/internal/products/skus/', data }, {}, 'products.skus.create');
...
export const fetchProductCategories = (params = {}) => requestWithMockFallback(
  { method: 'get', url: dictionaryApi('categories'), params }, [], 'products.categories'
);
export const fetchProductColors = (params = {}) => requestWithMockFallback(
  { method: 'get', url: dictionaryApi('colors'), params }, [], 'products.colors'
);
export const fetchProductAttributes = (params = {}) => requestWithMockFallback(
  { method: 'get', url: dictionaryApi('attributes'), params }, [], 'products.attributes'
);
...
export const fetchLegacyProductItems = (params = {}) => requestWithMockFallback(
  { method: 'get', url: dictionaryApi('legacy-items'), params }, [], 'products.legacy'
);
export const importLegacyProductItems = (csvText) => requestWithMockFallback(
  { method: 'post', url: dictionaryApi('legacy-items'), data: { csv_text: csvText } }, {}, 'products.legacy.import'
);
export const updateLegacyProductItem = (id, data) => requestWithMockFallback(
  { method: 'patch', url: `${dictionaryApi('legacy-items')}${id}/`, data }, {}, 'products.legacy.update'
);
export const generateLegacyProductItem = (id) => requestWithMockFallback(
  { method: 'post', url: `${dictionaryApi('legacy-items')}${id}/generate/` }, {}, 'products.legacy.generate'
);
