...
export const mockAuthUser = {
  ...
  permissions: [
    ...
    'development.requirement.view', 'development.requirement.manage', 'development.requirement.review',
    'development.project.view', 'development.project.manage', 'development.project.approve',
    'development.sample.view', 'development.sample.manage',
    'development.cost.view', 'development.cost.manage', 'development.cost.approve',
    'development.sales.view', 'development.sales.import',
    'development.review.view', 'development.review.manage', 'development.review.approve',
    'development.dashboard.view',
    'listings.template.view', 'listings.template.manage',
    'listings.profile.view', 'listings.profile.manage', 'listings.profile.approve', 'listings.profile.publish',
