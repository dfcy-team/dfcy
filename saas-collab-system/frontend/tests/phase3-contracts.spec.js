...
import { mockInventoryAlerts, mockReplenishmentSuggestions } from '../src/mock/replenishment';
import { mockLifecycleHistory, mockLifecycleReviews } from '../src/mock/lifecycle';
import { mockBusinessAlerts } from '../src/mock/alerts';
import { mockConfigItems, mockConfigVersions } from '../src/mock/configCenter';
...
const phase3Mocks = [
  ...
  mockReplenishmentSuggestions, mockLifecycleReviews, mockLifecycleHistory, mockBusinessAlerts,
  mockConfigItems, mockConfigVersions, mockFinanceAnalyticsOverview, mockReportExports
];
