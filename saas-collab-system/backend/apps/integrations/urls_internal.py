...
urlpatterns = [
    ...
    path("internal-api-clients/<int:pk>/review/", internal_api_clients.client_review, name="internal-api-client-review"),
    ...
    path("feishu/identities/system-users/<int:system_user_id>/binding/", feishu_api.identity_bind, name="feishu-identity-binding"),
