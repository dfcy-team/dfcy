...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['tenant', 'status'], name='idx_dev_product_archive_status'),
        ),
        migrations.AddIndex(
            model_name='developmentproductarchive',
            index=models.Index(fields=['tenant', 'platform', 'site'], name='idx_dev_product_archive_market'),
        ),
        migrations.AddConstraint(
            model_name='developmentproductarchive',
            constraint=models.UniqueConstraint(fields=('tenant', 'archive_no'), name='uniq_dev_product_archive_no'),
        ),
        migrations.AddIndex(
            model_name='developmentproductarchiveevent',
            index=models.Index(fields=['tenant', 'archive', 'created_at'], name='idx_dev_product_archive_event'),
        ),
    ]
