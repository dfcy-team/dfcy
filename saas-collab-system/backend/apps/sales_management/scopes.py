...
SCOPE_FIELD_MAP = {"store_ids": "store_id", "platforms": "platform", "regions": "region"}
FILTER_SCOPE_KEYS = {
...
def filter_sales_queryset(user, permission_code, queryset):
    ...
    for scope in scopes:
        ...
        for scope_key, model_field in SCOPE_FIELD_MAP.items():
