...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="ProductLegacyItem",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("legacy_spu_code", models.CharField(blank=True, max_length=120)),
                ("legacy_sku_code", models.CharField(max_length=160)),
                ("product_name", models.CharField(max_length=200)),
                ("attribute_code", models.CharField(blank=True, default="0", max_length=1)),
                ("color_code", models.CharField(blank=True, max_length=40)),
