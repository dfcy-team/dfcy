...
class Migration(migrations.Migration):
    # Local history has 0011_product_purchase_price.  Production's equivalent
    # is named 0010_product_purchase_price; the release review should map this
    # dependency when assembling the production migration graph.
