...
DEFINITIONS = (
    ...
    ("feishu.identity.manage", "管理飞书身份", "feishu", "identity.manage", "维护飞书身份映射。"),
    ...
    ("feishu.approval.manage", "管理飞书审批", "feishu", "approval.manage", "维护飞书审批映射。"),
    ("feishu.operations.view", "查看飞书运行记录", "feishu", "operations.view", "查看飞书脱敏运行记录。"),
    ("feishu.operations.retry", "重试飞书失败任务", "feishu", "operations.retry", "重试可补偿的失败任务。"),
)
