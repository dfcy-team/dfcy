PERMISSION_DEFINITIONS = (
    ...
    {
        "code": "integrations.store.view",
        "name": "View marketplace store authorizations",
        "module": "integrations",
        "action": "store.view",
        "description": "View tenant and store scoped Shopee or TikTok Shop authorization metadata.",
    },
    {
        "code": "integrations.store.authorize",
        "name": "Authorize marketplace stores",
        "module": "integrations",
        "action": "store.authorize",
        "description": "Create a marketplace store authorization using custody references.",
    },
    {
        "code": "integrations.store.revoke",
        "name": "Revoke marketplace store authorizations",
        "module": "integrations",
        "action": "store.revoke",
        "description": "Revoke one authorized marketplace store and append an audit record.",
    },
    {
        "code": "integrations.store.sync",
        "name": "Synchronize marketplace stores",
        "module": "integrations",
        "action": "store.sync",
        "description": "Request an approved marketplace store synchronization action.",
    },
    {
        "code": "integrations.store.retry",
        "name": "Retry marketplace store operations",
        "module": "integrations",
        "action": "store.retry",
        "description": "Retry one failed marketplace store operation.",
    },
    {
        "code": "integrations.credential.rotate",
        "name": "Rotate marketplace credential references",
        "module": "integrations",
        "action": "credential.rotate",
        "description": "Atomically rotate custody references without receiving platform credentials.",
    },
    {
        ...
        "module": "integrations",
        "action": "config.view",
        "description": "View tenant-scoped API platform configuration metadata.",
    },
    {
        "code": "integrations.config.create",
        "name": "Create API platform configurations",
        "module": "integrations",
        "action": "config.create",
        "description": "Create a tenant-scoped Shopee or TikTok Shop configuration.",
    },
    {
        "code": "integrations.config.update",
        "name": "Update API platform configurations",
        "module": "integrations",
        "action": "config.update",
        "description": "Update non-secret API platform configuration fields.",
    },
    {
        "code": "integrations.config.verify",
        "name": "Verify API platform configurations",
        "module": "integrations",
        "action": "config.verify",
        "description": "Run an approved connection verification without enabling synchronization.",
    },
    {
        "code": "integrations.config.disable",
        "name": "Disable API platform configurations",
        "module": "integrations",
        "action": "config.disable",
        "description": "Disable one tenant-scoped API platform configuration.",
    },
    {
        "code": "integrations.credential.clear",
        "name": "Clear API platform credentials",
        "module": "integrations",
        "action": "credential.clear",
        "description": "Revoke and clear custody references after explicit confirmation.",
    },
    {
        ...
        "module": "integrations",
        "action": "audit.view",
        "description": "View redacted tenant-scoped integration audit records.",
    },
    {
