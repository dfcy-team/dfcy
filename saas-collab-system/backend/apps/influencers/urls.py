...
from .views import (
    ...
    BdPerformanceView,
    BdPerformanceExportView,
    BdPerformanceDiagnosticView,
    SampleFulfillmentCollectionView,
    SampleFulfillmentDetailView,
    SampleFulfillmentOptionsView,
    SampleFulfillmentRestoreView,
    SampleFulfillmentStatusView,
    InfluencerResolveView,
)
...
urlpatterns = [
    ...
    path("<int:pk>/blacklist-history/", InfluencerBlacklistHistoryView.as_view(), name="influencer-blacklist-history"),
    path("resolve/", InfluencerResolveView.as_view(), name="influencer-resolve"),
    ...
    path("outreach-tasks/<int:pk>/restore/", OutreachTaskRestoreView.as_view(), name="outreach-task-restore"),
    ...
    path("sample-fulfillment-options/", SampleFulfillmentOptionsView.as_view(), name="sample-fulfillment-options"),
    path("sample-fulfillments/<int:pk>/", SampleFulfillmentDetailView.as_view(), name="sample-fulfillment-detail"),
    path("sample-fulfillments/<int:pk>/restore/", SampleFulfillmentRestoreView.as_view(), name="sample-fulfillment-restore"),
    ...
    path("bd-performance/", BdPerformanceView.as_view(), name="bd-performance"),
    path("bd-performance/export/", BdPerformanceExportView.as_view(), name="bd-performance-export"),
    path("bd-performance/diagnostics/", BdPerformanceDiagnosticView.as_view(), name="bd-performance-diagnostics"),
]
