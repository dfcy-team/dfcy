...
from .views import (
    ...
    OutreachTaskOptionsView,
    OutreachProductMatchView,
...
urlpatterns = [
    ...
    path("outreach-task-options/", OutreachTaskOptionsView.as_view(), name="outreach-task-options"),
    path("outreach-product-match/", OutreachProductMatchView.as_view(), name="outreach-product-match"),
