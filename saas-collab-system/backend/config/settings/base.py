...
LIVE_CUSTODY_BACKEND = os.getenv("LIVE_CUSTODY_BACKEND", "refuse")  # refuse | http
LIVE_CUSTODY_SERVICE_URL = os.getenv("LIVE_CUSTODY_SERVICE_URL", "")
LIVE_CUSTODY_SERVICE_HOST = os.getenv("LIVE_CUSTODY_SERVICE_HOST", "")

LIVE_OAUTH_REDIRECT_BASE = os.getenv("LIVE_OAUTH_REDIRECT_BASE", "")
...
LIVE_SHOPEE_AUTH_URL = os.getenv("LIVE_SHOPEE_AUTH_URL", "REPLACE_ME_CONFIRMED_ON_EXECUTION_DAY")
